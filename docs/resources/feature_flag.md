...
page_title: "ddff_feature_flag Resource - Datadog Feature Flags"
subcategory: ""
description: |-
...
```shell
#!/usr/bin/env bash
# Import an existing Datadog feature flag by its UUID.
terraform import ddff_feature_flag.new_checkout 4f8e31e1-307f-4a70-a245-9b2426d25415
```
